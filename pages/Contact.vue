    ...
    <section class="py-24">
      <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div class="grid lg:grid-cols-2 grid-cols-1 gap-x-24">
            ...
            <div class="lg:max-w-xl w-full h-[600px] flex items-center justify-center  bg-cover bg-no-repeat bg-[url('')] ">
                <div class="">
                    <div class="lg:w-96 w-auto h-auto bg-white shadow-xl lg:p-6 p-4">
                        ...
                        <a href="javascript:;" class="flex items-center mb-6">
                            ...
                            <h5 class="text-black text-base font-normal leading-6 ml-5">skip nomor telepon</h5>
                        </a>
                        <a href="javascript:;" class="flex items-center mb-6">
                            <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <h5 class="text-black text-base font-normal leading-6 ml-5">Dimas Prasetyo</h5>
                        </a>
                        <a href="javascript:;" class="flex items-center mb-6">
                            <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <h5 class="text-black text-base font-normal leading-6 ml-5">Jln Cipinang muara 1</h5>
                        </a>
                        <div class="flex items-center justify-center border-t border-gray-100 pt-6">
                            ...
                            <NuxtLink href="javascript:;" class="mr-6">
                                <svg width="31" height="30" viewBox="0 0 31 30" fill="none" xmlns="http://www.w3.org/2000/svg">
