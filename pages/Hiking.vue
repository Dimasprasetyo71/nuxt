  ...
  data() {
    return {
      product: {
        ...
        description: 'Hiking (walking) shoes are footwear specifically designed to protect the feet and ankles when carrying out outdoor walking activities such as hiking',
