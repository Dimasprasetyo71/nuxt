        ...
        <div class="w-full max-w-7xl px-4 md:px-5 lg-6 mx-auto">
            ...
            <div class="grid grid-cols-1 gap-8">
                    ...
                    <div class="col-span-12 lg:col-span-10 ">
                        <div class="sm:flex gap-6">
                            ...
                            <div class="text">
                                ...
                                <p class="font-normal text-base leading-7 text-gray-400 mb-4 lg:pr-8">Sepatu ini sangat nyaman untuk dipakai sehari-hari. Saya suka desainnya yang stylish dan cocok untuk semua kesempatan.</p>
                ...
                <div class="grid grid-cols-12 max-w-sm sm:max-w-full mx-auto">
                    <div class="col-span-12 lg:col-span-10 ">
                        <div class="sm:flex gap-6">
                            <img src="https://pagedone.io/asset/uploads/1704364533.png" alt="Robert image" class="w-32 h-32">
                            <div class="text">
                                <p class="font-medium text-lg leading-8 text-gray-900 mb-2">Robert Karmazov</p>
                                <div class="flex lg:hidden items-center gap-2 lg:justify-between w-full mb-5">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 30 30"
                                ...
                                <p class="font-normal text-base leading-7 text-gray-400 mb-4 lg:pr-8">
                                    Saya sangat puas dengan kualitas sepatu ini. Bahannya bagus dan tahan lama. Layak dengan harga yang dibayar.
                                </p>
                                <div class="flex items-center justify-between">
                ...
                <div class="grid grid-cols-12 max-w-sm sm:max-w-full mx-auto">
                    <div class="col-span-12 lg:col-span-10 ">
                        <div class="sm:flex gap-6">
                            <img src="https://pagedone.io/asset/uploads/1704364549.png" alt="Robert image" class="w-32 h-32">
                            <div class="text">
                                <p class="font-medium text-lg leading-8 text-gray-900 mb-2">Robert Karmazov</p>
                                <div class="flex lg:hidden items-center gap-2 lg:justify-between w-full mb-5">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 30 30"
                                ...
                                <p class="font-normal text-base leading-7 text-gray-400 mb-4 lg:pr-8">
                                    Desainnya bagus, tapi saya merasa ukurannya sedikit besar. Pengiriman juga agak lama, tapi overall sepatunya oke.
                                </p>
                                <div class="flex items-center justify-between">
                                    <div class="flex items-center gap-2">
                                        <a href="javascript:;" class="font-semibold text-lg cursor-pointer leading-8 text-indigo-600 whitespace-nowrap">
                ...
                <div class="grid grid-cols-12 max-w-sm sm:max-w-full mx-auto">
                    <div class="col-span-12 lg:col-span-10 ">
                        <div class="sm:flex gap-6">
                            <img src="https://pagedone.io/asset/uploads/1704364560.png" alt="Robert image" class="w-32 h-32">
                            <div class="text">
                                <p class="font-medium text-lg leading-8 text-gray-900 mb-2">Robert Karmazov</p>
                                <div class="flex lg:hidden items-center gap-2 lg:justify-between w-full mb-5">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 30 30"
                                ...
                                <p class="font-normal text-base leading-7 text-gray-400 mb-4 lg:pr-8"> Sepatu ini sesuai ekspektasi saya. Saya senang dengan pengiriman yang cepat dan pelayanan dari Dims Store yang responsif. </p>
                                <div class="flex items-center justify-between">
                                    <div class="flex items-center gap-2">
